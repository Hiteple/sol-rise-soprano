...
type: CareerPage
heroEyebrow: ''
heroTitleLine1: Ein sich
heroTitleAccent: entwickelnder
heroTitleLine2: Opernweg
heroIntro: "Geboren in Buenos Aires, Argentinien, entdeckte Sol Risé ihre Stimme im Alter von neun Jahren. Was als kindliche Faszination begann, wurde zu einer lebenslangen Berufung — und prägte einen künstlerischen Weg im operatischen Repertoire."
heroImage: images/salon-dorado/IMG_5954.webp
heroImageAlt: Sol Risé im Salón Dorado des Teatro Colón
heroQuote: '"Zu singen ist nicht das, was ich tue — es ist, wer ich bin."'
heroQuoteAttribution: — Sol Risé
statsSurface: wine
highlights:
  - number: 7+
    label: Jahre auf der Bühne
  - number: '20+'
    label: Aufführungen
  - number: '2'
    label: Hauptrollen
...
timeline:
  - year: '2019'
    ...
    description: |+
      <div style="text-align: left"><ul>
       <li>Chormitglied in Produktionen von <em>La Traviata</em> und <em>Die Zauberflöte</em> am Teatro Avenida</li>
      </ul></div>
  ...
  - year: '2021'
    ...
    description: |+
      <div style="text-align: left"><ul>
       <li>Rolle der Mrs. Gobineau in <em>The Medium</em></li>
      </ul></div>
  ...
  - year: '2022'
    ...
    description: |+
      <div style="text-align: left"><ul>
       <li>Rolle der Annina in <em>La Traviata</em> in Buenos Aires (März)</li>
       <li>Rolle der Contessa di Ceprano mit Celebrarte Música (Mai)</li>
       <li>Stipendiaten-Solistin beim Opernfestival und Chormitglied in <em>Carmen</em> mit Juventus Lyrica am Teatro Avenida</li>
      </ul></div>

  - year: '2023'
    title: >-
      Juventus Lyrica, Teatro Colón, Festival Internacional de la Cultura
      (Potosí, Bolivien) & Teatro Argentino de La Plata
    description: |+
      <div style="text-align: left"><ul>
  ...
  - year: '2024'
    ...
    description: |+
      <div style="text-align: left"><ul>
       ...
       <li>Solistin bei Juventus Lyricas 25-Jahre-Gala mit Ensembles und Duetten am Teatro Avenida (Oktober)</li>
       <li>Chorverstärkung in Brahms' <em>Gesang der Parzen</em>, Op. 89, und <em>Nänie</em>, Op. 82, unter Elías Grandy am Teatro Colón (November)</li>
      </ul></div>

  - year: '2025'
    title: >-
      Juventus Lyrica, Valkyria Lírica, British Arts Centre & Festival
      Internacional de la Cultura (Potosí und Sucre, Bolivien)
    description: |+
      <div style="text-align: left"><ul>
       <li>Chormitglied und Erscheinungen in <em>Macbeth</em> mit Juventus Lyrica (September)</li>
       <li>Chormitglied in <em>Il Trovatore</em> mit Valkyria Lírica (September)</li>
       <li>Rolle der Pamina in <em>Die Zauberflöte</em> (reduzierte deutschsprachige Kinderfassung) im British Arts Centre mit Nina Caluzo (Oktober)</li>
       <li>Solistin in Carl Orffs <em>Carmina Burana</em> in Potosí und Sucre, Bolivien, im Rahmen des Festival Internacional de la Cultura (November und Dezember)</li>
      </ul></div>
...
ctaTitleLine1: Anfragen & Kontakt
ctaTitleLine2: ''
